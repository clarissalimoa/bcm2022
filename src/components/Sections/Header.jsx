  ...
  return (
    <Wrapper id="home" className="container flexSpaceCenter">
      <LeftSide className="flexCenter">
        <div>
          <h1 className="extraBold font60">Basic Christian Maturity</h1>
          <HeaderP className="font13 semiBold">
            Salam Damai Kristus, Selamat datang Bapak, Ibu dan Saudara-i yang
            terkasih di halaman pengenalan BCM ( Basic Christian Maturity ).
          </HeaderP>
        </div>
      </LeftSide>
      <RightSide>
